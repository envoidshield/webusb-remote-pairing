...
export var ncmDebugLog = null;
export function setNcmDebugLog(fn) { ncmDebugLog = fn; }
function debug(msg) {
    if (ncmDebugLog)
        ncmDebugLog(msg);
}
export function hexDump(data, maxBytes = 64) {
 ...
 */
export function parseNcmTransfer(raw) {
...
let ncmSequence = 0;
export function buildNcmTransfer(ethernetFrame) {
