...
export async function saveStore(store) {
    await idbPut({
        ...
        devices: Object.keys(store.devices).reduce((acc, udid) => {
...
export function createSelfIdentity(ed25519) {
...
export async function getOrCreateSelfIdentity() {
...
export async function saveTrustRecord(udid, selfId, hostKey) {
...
export function trustRecordToPlistXml(_udid, rec) {
    return buildTrustRecordPlist(rec);
}
export function downloadPlist(filename, xml) {
...
export async function saveDeviceRecord(udid, rec, selfIdentity) {
...
export function buildTrustRecordPlist(rec) {
    return [
...
export function downloadTrustRecord(udid, rec) {
